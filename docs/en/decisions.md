...
CellHive records every design decision as an ADR. **The full ADR text is written in Chinese**: [`../decisions.md`](../decisions.md) is the authoritative record (ADR-001 ~ 177). This page is an English index of the titles and one-line summaries; read the Chinese record for the full rationale, evidence and cost of each decision.
